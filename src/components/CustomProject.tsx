        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="https://api.whatsapp.com/send?phone=5548988164249&text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20um%20projeto%20sob%20medida."
                target="_blank"
